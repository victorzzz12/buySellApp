...
### Requirements:
* users can favourite items to check up on them later --requires fixing of first input of favorites
* users can send messages to the user that is listing the item 

### Admins can:

* post items, which can be seen by others --requires fixing
* remove items from the site --requires fixing
* mark items as SOLD!, --requires fixing
